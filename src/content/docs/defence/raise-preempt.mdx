...
- 2!n: Depends on situations
    - (1) If strength is possible, then it is Nat (15-18 bal / semi-bal)
    - (2) Else if partner has shown strength, then it is Scramble
    - (3) Else, unusual 2N. Lowest 2 unbid suit
- NJS: Nat. Constructive
...
- 1!n (3X)
- 1!d (3X)
- Any modes of the above sequences
...
- 3!n: To play
- 4m: 5+m 5+oM GF
- Cue: 2-suiter with serious slam interest
- 4!s/5m: To play
- 4!n: Minors
</BiddingTree>
