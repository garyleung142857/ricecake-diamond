...
### Opening Opposite a Passed Hand
...
<BiddingTree>
1!d
- 1!h: 0-7 Catch all. Others 8+ GF Relay
...
- 1!n: 17-19 Bal. 1!n development
- 2X: 17-21. Unbal 5+X NF (not 5+4+ majors)
- 2!n: 20-22 Bal. 2!n development
- 3X: Nat. Good suit. GF
</BiddingTree>
...
- New Suit: 6+HCP. 5+card suit. F1
- Jump shift: Competitive. NF
...
- New Suits: Forcing if below game.
- Jump shift: Good suit and forcing if below game
- Raises (by Opener): GF. Jump in opp's suit / 4-level shows shortness. 
- Raises (by Responder): simple raise is NF (if not already GF).
- Cue (by Opener): GF. Asks stopper.
- Cue (by Responder): F1. Catchall
...
Continuation please refer to Module section. Mode 0.
...
4!c over 3!d/!h/!s, 4!d over 3!c, and 4!n over 4M asks Keycards.
...
<BiddingTree>
3!n
- 4!c: StaticRange. Should be able to distinguish the major. Ask side King
    - 4M: No side King
    - 4!d/4oM/5!c: Side King in the bid suit
    - 4!n: Two side Kings
