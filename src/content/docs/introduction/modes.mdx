...
- P - 1M and P - 2m have different developments ([Modified Drury](/openings/1major-cs/#modified-drury) and [2m passed responses](/openings/2minor-cs/#2m-passed-response))
