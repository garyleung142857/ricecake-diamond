...
- CS bidder: 
    - (NV) 8-11 unbal / 10-13 Bal
    - (Vul) 8-11 unbal / 14-16 Bal
- Partner: Any strength

### Mode 1: 1!c - CS

- CS bidder
    - (NV) 8-11 unbal / 9-11 Bal
    - (Vul) 8-11 unbal / 8-9 bal
- Partner
    - (NV) 12-16 unbal / 14-16 bal
...
- Partner: 
    - (NV) 0-7 unbal or 0-9 bal
    - (Vul) 0-7 unbal or 0-11 bal
- Same as Mode 0, except <u>partner borrows 3 HCPs from the CS bidder</u>
- P - 1M and P - 2m have different developments ([Modified Drury](/ricecake-diamond/junior/modules/cornerstones/#modified-drury) and [2m passed responses](/ricecake-diamond/junior/modules/cornerstones/#2m-passed-response))
