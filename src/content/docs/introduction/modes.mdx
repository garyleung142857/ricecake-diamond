...
- P - 1M and P - 2m have different developments ([Modified Drury](/ricecake-diamond/openings/1major-cs/#modified-drury) and [2m passed responses](/ricecake-diamond/openings/2minor-cs/#2m-passed-response))
